...
# install.packages(c("rsconnect", "configr", "mcd-conteo-rapido"))
...
# use this when working locally and comment the line above:
# shinyconf <- read.config(file = "./mcd-conteo-rapido/shiny.json")
