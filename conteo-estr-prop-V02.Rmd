...
```{r}
  ...
  for(i in 1:M){
    ...
    #Y gorro = estTotal = df.temporal$Wh %*% df.temporal$PAN
    #X gorro = df.temporal$Wh %*% df.temporal$Total
...
```{r}
MinPAN <- simulacionESTR.prop$MinPAN
MaxPAN <- simulacionESTR.prop$MaxPAN
